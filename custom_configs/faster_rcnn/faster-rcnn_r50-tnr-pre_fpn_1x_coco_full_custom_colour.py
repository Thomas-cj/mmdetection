...
#custom_imports = dict(imports=['datasets.transforms.custom_hue'], allow_failed_imports=False)
custom_imports = dict(imports=['custom_configs.faster_rcnn.custom_hue'], allow_failed_imports=False)
...
train_pipeline = [
    ...
    dict(type='Brightness', prob=0.2, min_mag=0.5, max_mag=1.5),
    #dict(type="Color", prob=0.2),
    dict(type="CustomHue", prob=0.2),
